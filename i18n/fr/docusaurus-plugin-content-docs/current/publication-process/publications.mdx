...
Un **dossier de publication** créé à partir des [Étapes communes du flux de travail](./overview.mdx#common-workflow-steps) dans le PSO ne peut pas être supprimé !
