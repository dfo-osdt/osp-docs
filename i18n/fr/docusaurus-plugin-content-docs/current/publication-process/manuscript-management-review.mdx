...
Un MRF **doit** indiquer un [**intérêt potentiel pour le public**](./manuscript_record_form.mdx#indicate-potential-public-interest) afin de pouvoir être signalé dans le **Cahier de planification** du PSO.
