...
Créez un formulaire de dossier de manuscrit (MRF) pour commencer le suivi d'une publication dans le Portail de science ouverte (PSO). Le MRF contient les renseignements sur le manuscrit et soutient le processus d’examen de gestion de la publication.

:::tip
**Enregistrez votre progression**

Enregistrez fréquemment votre manuscrit afin d’éviter toute perte de données.
...
Après avoir enregistré vos modifications, vous pouvez quitter le PSO en toute sécurité.
:::

## Ouvrir la page Mes dossiers de manuscrits {/* #open-the-my-manuscripts-page */}

La page **Mes dossiers de manuscrits** répertorie tous les dossiers de manuscrits que vous avez créés ou qui ont été partagés avec vous.

**Étapes**

1. Survolez la barre latérale gauche pour développer le menu de navigation.
2. Cliquez sur **Mes dossiers de manuscrits**.

**Résultat**

La page **Mes dossiers de manuscrits** s’affiche et présente tous les dossiers de manuscrits associés à votre compte, y compris les brouillons et les dossiers partagés.
...
Créez un nouveau MRF à partir de la page **Mes dossiers de manuscrits**.
...
![Navigation dans le formulaire de dossier de manuscrit](./images/navigating_mrf.png)

### Informations supplémentaires {/* #additional-information-1 */}

- **Menu des sections** – Utilisez la barre latérale gauche pour accéder aux sections telles que **Renseignements généraux**, **Auteurs**, **Évaluateurs par les pairs** et **Sources de financement**.
...
- **Progression du manuscrit** – Ouvre la page [Progression du manuscrit](#view-manuscript-progress) et affiche le flux de travail ainsi que l’état d’avancement actuel du MRF.
- **Partage** – Ouvre la page [Partage](#share-a-manuscript-record-form), où vous pouvez partager le MRF avec d’autres utilisateurs. Les auteurs et les participants à l’examen de gestion disposent automatiquement de l’accès et n’ont pas besoin d’être ajoutés.
...
Après la création d’un MRF, le système lui attribue un identifiant unique et lui assigne l’état **Brouillon**. Vous devez remplir tous les champs obligatoires avant de soumettre le manuscrit pour l’examen de gestion.
...
1. Cliquez sur le champ **Déposez un fichier ou cliquez pour téléverser un manuscrit**.
2. Sélectionnez le fichier PDF du manuscrit à partir de l’explorateur de fichiers.
...
Ajoutez tous les auteurs ayant contribué au manuscrit et indiquez leurs affiliations.
...
2. Activez ou désactivez le bouton coulissant **Auteur correspondant du MPO**.

**Résultat**

Le statut d’**auteur correspondant du MPO** de l’auteur est mis à jour.
...
1. Cliquez sur **+**.
2. Recherchez l’évaluateur à l’aide de son nom ou de son adresse courriel.
...
Le titre de travail est automatiquement renseigné à partir du titre saisi lors de la création du manuscrit.
...
Vous pouvez enregistrer vos modifications de deux façons :
...
Le dossier du manuscrit indique si la publication est susceptible de susciter un intérêt auprès du public.
...
Partagez l’accès à un formulaire de dossier de manuscrit (MRF) avec un autre utilisateur, par exemple un administrateur ou un chef de section.

:::tip
Les auteurs du MPO et les évaluateurs associés au MRF disposent déjà de l’accès en fonction de leur rôle et n’ont pas besoin d’être ajoutés manuellement.
:::
...
- Suivez les étapes décrites dans **[Inviter un utilisateur](../support-and-resources/more-features#invite-a-user)**.

**Résultat**

L’utilisateur sélectionné reçoit l’accès au formulaire de dossier de manuscrit avec les autorisations attribuées.

![Nouveau partage](./images/new_share.png)

## Modifier les autorisations de partage {/* #edit-share-permissions */}

Mettez à jour les autorisations d’un formulaire de dossier de manuscrit partagé.
...
## Retirer les autorisations de partage {/* #remove-share-permissions */}
