...
# Page Mes dossiers de manuscrit
...
- **ORCID** : Un cercle vert contenant les lettres « iD » à gauche du nom d’un auteur indique que celui-ci a associé un [ORCID](../references/orcid.mdx) à son compte.
...
- **Dupliquer** : Un carré gris contenant une flèche pointant vers l’intérieur représente l’[action de duplication](./manuscript-record-form-features.mdx#duplicate-a-manuscript-record-form). Cette action vous permet de créer une copie de ce MRF.
