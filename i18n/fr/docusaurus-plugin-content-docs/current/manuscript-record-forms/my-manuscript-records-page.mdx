...
- **Dupliquer** : Un carré gris contenant une flèche pointant vers l’intérieur représente l’[action de duplication](./manuscript-record-form-features#duplicate-a-manuscript-record-form). Cette action vous permet de créer une copie de ce MRF.
