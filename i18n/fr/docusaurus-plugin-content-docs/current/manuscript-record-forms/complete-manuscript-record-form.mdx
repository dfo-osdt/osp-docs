...
- Consultez [**Créer un nouvel auteur**](../common-features/author-and-affiliate-management.mdx#create-a-new-author) si un auteur ne figure pas dans la liste de recherche.
- Consultez [**Créer une nouvelle organisation**](../common-features/author-and-affiliate-management.mdx#create-a-new-organization) si une organisation ne figure pas dans la liste de recherche.
...
Une publication ne peut être signalée pour le [**Cahier de planification**](../manuscript-management-review/submit-review.mdx#planning-binder) que si elle présente un intérêt public potentiel!
