...
Créez un formulaire de dossier de manuscrit (MRF) pour commencer à faire le suivi d’une publication dans le Portail de la science ouverte (PSO). Le MRF contient les détails du manuscrit et appuie le processus d’examen de la publication.
...
- **Progression du manuscrit** – Ouvre la page [Progression du manuscrit](./manuscript-record-form-features#view-manuscript-progress) et affiche le déroulement du processus ainsi que la progression actuelle du MRF.
...
- **Publication** – Ouvre le [dossier de publication](../publications/) associé, s’il existe. Un dossier de publication est automatiquement créé lorsque le manuscrit est marqué comme accepté pour publication.
...
- **Actions** : Affiche les actions disponibles pour le MRF.
...
- **Demandeur** : Indique la personne qui a créé le MRF.
