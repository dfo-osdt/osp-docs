...
Créez un formulaire de dossier de manuscrit (MRF) afin de commencer le suivi d'une publication dans le Portail de la science ouverte (PSO). Le MRF conserve les renseignements sur le manuscrit et soutient le processus d'examen de la publication.
...
Vous pouvez enregistrer votre progression de l'une des façons suivantes :

- En cliquant sur l'icône circulaire **Disquette** située dans le coin inférieur droit de la page.
- En faisant défiler la page jusqu'au bas du formulaire et en cliquant sur **Enregistrer**.

Après avoir enregistré votre travail, vous pouvez fermer votre session du PSO en toute sécurité.
:::

## Page Mes manuscrits {/* #my-manuscripts-page */}

La page **Mes manuscrits** répertorie tous les dossiers de manuscrits que vous avez créés ou qui ont été partagés avec vous. Par défaut, elle affiche les MRF qui ont été soumis et qui sont en cours d'examen de gestion du manuscrit. Vous pouvez modifier l'affichage actuel des MRF ou créer un nouveau MRF à partir du menu **Dossiers de manuscrits** situé sur le côté gauche de la page.
...
Un nouveau formulaire de dossier de manuscrit est créé et s'ouvre en mode modification.

### Informations supplémentaires {/* #additional-information */}

- Cliquez sur **Retour** pour modifier les renseignements saisis aux étapes précédentes.
- Cliquez sur **Annuler** pour quitter le processus de création du manuscrit sans enregistrer les modifications.

## Naviguer dans le formulaire de dossier de manuscrit {/* #navigate-the-manuscript-record-form */}

Le formulaire de dossier de manuscrit est organisé en sections qui vous permettent de saisir les renseignements relatifs au manuscrit.

![Navigation du formulaire MRF](./images/navigating_mrf.png)

### Informations supplémentaires {/* #additional-information-1 */}

- **Menu des sections** – Utilisez le menu latéral gauche pour accéder à des sections telles que **Renseignements généraux**, **Auteurs**, **Évaluateurs par les pairs** et **Sources de financement**.
- **Indicateurs de progression** – Les sections comportant des champs obligatoires incomplets sont mises en évidence.
- **Champs obligatoires** – Les champs marqués d’un astérisque (*) doivent être remplis avant de pouvoir soumettre le formulaire.
- **Options d’enregistrement** – Enregistrez votre progression en utilisant le bouton **Disquette** ou le bouton **Enregistrer**.
- **État du formulaire** – Le coin supérieur droit affiche l’état du manuscrit (par exemple, **Brouillon** ou **En examen**).
...
- **Examen de gestion du manuscrit** – Ouvre la page [Examen de gestion du manuscrit](manuscript-management-review.mdx) et affiche l’état actuel de l’examen.
- **Progression du manuscrit** – Ouvre la page [Progression du manuscrit](#view-manuscript-progress) et affiche le flux de travail ainsi que l’état d’avancement du MRF.
- **Partage** – Ouvre la page [Partage](#share-a-manuscript-record-form), où vous pouvez partager le MRF avec d’autres utilisateurs. Les auteurs et les utilisateurs participant à l’examen de gestion ont automatiquement accès au MRF et n’ont pas besoin d’être ajoutés.
- **Publication** – Ouvre le dossier de [Publication](./publications.mdx) associé, s’il existe. Un dossier de publication est créé lorsque le manuscrit est marqué comme étant accepté pour publication.

## Remplir le formulaire de dossier de manuscrit {/* #complete-the-manuscript-record-form */}

Après la création d’un MRF, le système lui attribue un identifiant unique et définit son état à **Brouillon**. Vous devez remplir tous les champs obligatoires avant de soumettre le manuscrit pour l’examen de gestion.
...
L’affiliation **MPO** est sélectionnée par défaut afin d’accélérer la saisie des données. Modifiez l’affiliation lorsque vous ajoutez des auteurs provenant d’autres organisations.
:::
...
1. Cliquez sur **+**.
2. Recherchez l’auteur dans le champ **Auteur** en utilisant son nom ou son adresse courriel.
3. Sélectionnez **Oui** pour **Auteur correspondant** si cet auteur sera la personne-ressource principale au sein du MPO.
...
1. Cliquez sur l’icône **X** située à côté du nom de l’auteur.
2. Cliquez sur **OK**.
...
:::important
L’**auteur correspondant du MPO** est la personne responsable de répondre aux questions concernant le manuscrit au sein du MPO. Il peut s’agir d’une personne différente de l’auteur correspondant indiqué dans l’article publié.
:::
...
Si l’auteur recherché n’apparaît pas dans la liste, créez un nouveau dossier d’auteur.
...
:::info
Le PSO enregistre les **auteurs collectifs** afin d’identifier les organisations et les groupes de travail ayant contribué au processus de publication. La **liste des auteurs** sert à attribuer le crédit pour le manuscrit.
:::
...
Répétez les étapes suivantes pour chaque évaluateur par les pairs :
...
- Au moins **deux experts en la matière** doivent effectuer une évaluation par les pairs du rapport.
- La section **Évaluation par les pairs** n’apparaît pas dans le MRF des publications de revues tierces puisqu’elle n’est pas requise.

---

## Mettre à jour le titre provisoire du manuscrit {/* #update-the-manuscript-working-title */}

Le titre provisoire est automatiquement rempli à partir du titre saisi lors de la création du manuscrit.

![Renseignements généraux](./images/general_information.png)
...
Vous pouvez enregistrer vos modifications de l’une des façons suivantes :

- En cliquant sur l’icône **Disquette** située dans le coin inférieur droit de la page.
- En faisant défiler la page jusqu’au bas de celle-ci et en cliquant sur **Enregistrer**.

## Mettre à jour la région responsable {/* #update-the-lead-region */}

La **région responsable** est automatiquement renseignée à partir de la région sélectionnée lors de la création du manuscrit.
...
Ajoutez un résumé en langage clair (RLC) afin d’améliorer l’accessibilité de la publication.
...
## Confirmer l’approbation du résumé en langage clair par l’auteur {/* #confirm-author-approval-of-the-plain-language-summary */}

Confirmez que l’auteur a examiné et approuvé le résumé en langage clair.

**Étapes**

1. Passez en revue le résumé en langage clair complété.
...
## Sélectionner un secteur fonctionnel {/* #select-a-functional-area */}

Attribuez une étiquette de **secteur fonctionnel** afin de classifier le domaine de recherche du manuscrit.
...
Les étiquettes de secteur fonctionnel contribuent à améliorer la production de rapports et le suivi des domaines de recherche scientifique du MPO.

## Ajouter le résumé de la pertinence {/* #add-the-relevance-summary */}

Fournissez un résumé expliquant comment le manuscrit appuie le programme qui l’a financé et comment il s’aligne sur le mandat du Ministère, son plan stratégique ou les priorités régionales.
...
## Indiquer l’intérêt potentiel pour le public {/* #indicate-potential-public-interest */}

Indiquez si le manuscrit est susceptible de susciter un intérêt auprès du public.

:::info

Une publication ne peut être signalée dans le [**Cahier de planification**](./manuscript-management-review.mdx#planning-binder) que si elle présente un intérêt potentiel pour le public !
...
Le dossier de manuscrit indique si la publication est susceptible de susciter un intérêt auprès du public.

![Intérêt public](./images/public_interest.png)

---

## Définir la licence du rapport {/* #set-report-licensing */}

Indiquez si le rapport doit être publié sous la **[Licence du gouvernement ouvert – Canada](https://open.canada.ca/fr/licence-du-gouvernement-ouvert-canada)**.

:::tip
Cette section est visible uniquement pour les **publications scientifiques et techniques secondaires du secteur des SEO**.
:::
...
Le MPO applique le principe de la science ouverte **« Ouvert par conception et par défaut »**. Les publications devraient être diffusées sous la version la plus récente de la **Licence du gouvernement ouvert – Canada**, dans la mesure du possible.

La licence ne doit pas être appliquée si des obligations de licence incompatibles existent.

---

## Indiquer si la publication sera en libre accès {/* #indicate-open-publication */}

Indiquez si la publication sera rendue accessible en libre accès.
...
Le dossier de manuscrit indique si la publication sera accessible en libre accès.

### Informations supplémentaires {/* #additional-information-13 */}

L’approche **« Ouvert par conception et par défaut »** exige que les publications soient librement accessibles au public, sauf lorsqu’une exception s’applique.

Les exceptions peuvent notamment inclure des situations où les renseignements, les données ou le code sont assujettis à des restrictions en raison :

- de la sécurité de la recherche;
- d’intérêts exclusifs;
- de restrictions imposées par des tiers;
- d’exigences juridiques, éthiques ou d’ententes de confidentialité.

## Ajouter des sources de financement {/* #add-funding-sources */}

Ajoutez des sources de financement si les travaux ayant contribué au manuscrit ont été financés par un programme.
...
Après avoir ajouté des sources de financement, enregistrez vos modifications de l’une des façons suivantes :
...
Mettez à jour les renseignements d’une source de financement existante.
...
Les renseignements mis à jour de la source de financement sont enregistrés.
...
## Soumettre le manuscrit pour l’examen de gestion {/* #submit-the-manuscript-for-management-review */}

Soumettez le formulaire de dossier de manuscrit (MRF) une fois que tous les champs obligatoires ont été remplis.

:::important
Le **demandeur du MRF ou tout auteur inscrit** peut soumettre le manuscrit pour l’examen de gestion.

L’utilisateur qui soumet le MRF devient automatiquement le **demandeur du MRF**.

Si la personne qui a créé le MRF **n’est pas un auteur** (par exemple, un adjoint administratif), elle pourrait perdre l’accès au MRF après la soumission. Un auteur pourra lui redonner accès au MRF au besoin.
:::

**Étapes**

1. Faites défiler la page jusqu’au bas de la page **Dossier de manuscrit**.
2. Cliquez sur **Soumettre**.
3. Passez en revue l’énoncé de consentement de la **Soumission pour l’examen de gestion**.
...
2. Entrez le **prénom**, le **nom**, l’**adresse courriel** et la **langue préférée** du gestionnaire.
3. Cliquez sur **Inviter**.

**Résultat**

Le manuscrit est soumis pour l’examen de gestion.

Pour confirmer la soumission, vérifiez la case **État** située dans le coin supérieur droit de la page **Dossier de manuscrit**. L’état devrait afficher **En examen**.

![Ajouter un gestionnaire](./images/add_manager.png)

![En examen](./images/in_review.png)

---

## Soumettre le manuscrit pour publication {/* #submit-the-manuscript-for-publication */}

Après avoir terminé le **processus d’examen de gestion du manuscrit**, vous pouvez soumettre le manuscrit à **Publications scientifiques**.

### Publication scientifique et technique secondaire du secteur des SEO {/* #eos-secondary-scientific-and-technical-publication */}

:::warning
**Renseignements requis**

Vous devez obtenir un **numéro de catalogue** avant de soumettre le manuscrit à Publications scientifiques.
...
## Soumettre le manuscrit à Publications scientifiques {/* #submit-the-manuscript-to-science-publications */}

Soumettez le manuscrit à **Publications scientifiques** après avoir terminé le processus d’examen de gestion du manuscrit.

![Soumettre à Publications scientifiques](./images/submit_science_publications.png)
...
- **ISBN** – Entrez le numéro ISBN, s’il y a lieu.
...
Le manuscrit est soumis à **Publications scientifiques** pour examen et publication. Vous recevrez une notification lorsque le manuscrit sera publié ou si des modifications sont requises.

:::info
Vous pouvez tout de même téléverser votre manuscrit au format PDF. Toutefois, Publications scientifiques ne pourra pas y apporter de modifications au besoin. Si des modifications sont requises, Publications scientifiques communiquera avec vous par courriel.
:::
...
Continuez à mettre à jour le formulaire de dossier de manuscrit tout au long du processus de publication afin d’améliorer les indicateurs liés aux délais de publication et d’accroître la visibilité des travaux.
...
- saisir la date au format **AAAA-MM-JJ**;
- ou sélectionner la date à l’aide de l’icône **Calendrier**.
...
Enregistrez la date à laquelle le manuscrit a été accepté pour publication.
...
Si la revue ne figure pas dans la liste :

- Envoyez un courriel à l’**équipe de soutien du PSO** pour demander son ajout :  
  DFO.OpenScience-ScienceOuverte.MPO@dfo-mpo.gc.ca

**Résultat**

Le formulaire de dossier de manuscrit est mis à jour afin d’indiquer que le manuscrit a été accepté pour publication.
...
La page **Progression du manuscrit** affiche l’état actuel du flux de travail et les principales étapes de publication du manuscrit.
...
Les utilisateurs ayant le rôle **Éditeur régional** peuvent consulter et modifier les formulaires de dossier de manuscrit (MRF) dont leur région est la **région responsable**.

- Lorsque le MRF est à l’état **Brouillon** ou **En examen**, les éditeurs régionaux peuvent le modifier et enregistrer les changements.
- Lorsque le MRF est à l’état **Examiné**, les éditeurs régionaux peuvent seulement le consulter.
...
- Entrez un titre de manuscrit ou un nom d’auteur dans le champ **Filtre**.
...
Partagez l’accès à un formulaire de dossier de manuscrit (MRF) avec un autre utilisateur, comme un adjoint administratif ou un chef de section.

:::tip
Les auteurs et les évaluateurs du MPO associés au MRF disposent déjà d’un accès selon leur rôle et n’ont pas besoin d’être ajoutés manuellement.
:::
...
- Suivez les étapes de la section **[Inviter un utilisateur](../support-and-resources/more-features#invite-a-user)**.
...
Mettez à jour les autorisations d’un formulaire de dossier de manuscrit déjà partagé.
