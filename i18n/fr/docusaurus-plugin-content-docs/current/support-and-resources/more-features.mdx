...
Certains utilisateurs peuvent avoir des adresses courriel semblables. Assurez-vous de sélectionner le bon utilisateur.

Pour vous aider à identifier le bon utilisateur, le système affiche **la description de poste provenant de l’Active Directory** dans les résultats de recherche.
:::
...
## Retirer un MRF de l’examen de gestion {/* #unsubmit-a-mrf-from-manuscript-management-review */}

Un formulaire de dossier de manuscrit (MRF) peut être retiré de l’examen de gestion et remis à l’état **BROUILLON** en tout temps.

**Étapes**

1. Ouvrez le MRF que vous souhaitez retirer de l’examen de gestion.
2. Cliquez sur **Retirer**.
3. Entrez le motif du retrait.
4. Confirmez l’action.

**Résultat**

- Le MRF est retiré de l’examen de gestion et son état passe de **En examen** à **Brouillon**.
- Une notification par courriel est envoyée au gestionnaire responsable de l’examen ainsi qu’à l’auteur, indiquant le motif du retrait.

![Retirer un MRF](./images/unsubmit-mrf.png)

![Courriel de retrait](./images/unsubmit-email.png)

## Retirer un MRF du processus d’examen de gestion {/* #withdraw-a-mrf-from-manuscript-management-review */}

Retirez un formulaire de dossier de manuscrit (MRF) du processus de publication après qu’il a été soumis à l’examen de gestion.

Ce processus nécessite des actions de la part du **gestionnaire responsable de l’examen** et de **l’auteur**.

### Gestionnaire : Demander des révisions {/* #manager-request-revisions */}

**Étapes**

1. Ouvrez l’examen de gestion du manuscrit associé au MRF.
