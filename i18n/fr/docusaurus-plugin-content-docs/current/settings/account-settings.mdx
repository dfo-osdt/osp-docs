...
#### Si votre domaine d’expertise n’est pas répertorié {/* #if-your-area-of-expertise-is-not-listed */}

Si votre domaine d’expertise n’est pas trouvé dans le champ de recherche, vous pouvez l’ajouter au PSO !  
Une fois un domaine d’expertise créé, il devient accessible à tous les utilisateurs du PSO.

Pour créer un domaine d’expertise :

1. Cliquez sur **MODIFIER**.
2. Cliquez dans la barre de recherche Expertise et saisissez votre domaine d’expertise.
3. Cliquez sur **Vous ne trouvez pas l’expertise recherchée ? +**.
4. Entrez le nom de l’expertise en anglais et en français (utilisez le même nom dans les deux champs s’il n’existe pas d’équivalent français ou anglais).
5. Cliquez sur **CRÉER**

![Créer une expertise](./images/create_expertise.png)
...
Les membres de votre groupe de notifications recevront des courriels du processus d’examen de gestion du manuscrit dans les situations suivantes :

- Soumission d’un manuscrit à l’examen de gestion.
- Notifications des étapes d’examen (nouveau gestionnaire examinateur assigné).
- Retrait d’un manuscrit de l’examen de gestion par l’auteur.
- Rappels d’échéance et de dépassement de délai pour l’examen de gestion.
