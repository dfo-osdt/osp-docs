...
3. Apply changes to the Manuscript Record. For more details, see [Populating an MRF](/publication-process/manuscript-record-form.mdx#complete-the-manuscript-record-form).
4. Click the **Manuscript Management Review** button in the side menu to return to the Manuscript Management Review page.

### Review the Potential Public Interest Section {/* #review-the-potential-public-interest-section */}
