...
3. Apply desired edits to the Potential Public Interest (Optional).
...
![Review with Interest](./images/review_with_interest.png)
...
A MRF **must** have [Potential Public Interest](manuscript-record-form.mdx#indicate-potential-public-interest) in order to be flagged for the Planning Binder within the OSP.
