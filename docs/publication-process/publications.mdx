...
This will mark your publication as "Published" and make it viewable under the [Publication Explorer](../portal-features/publication-explorer.mdx).
...
A **Publication Record** that is created through the [Common Workflow Steps](./overview.mdx#common-process-steps) within the OSP cannot be deleted!
