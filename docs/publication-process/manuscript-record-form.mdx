...
![Dashboard](/img/publication-process/my_manuscripts_page.png)

## Create a New Manuscript Record Form
...
## Navigate the Manuscript Record Form

The Manuscript Record Form is organized into sections that allow you to enter manuscript details.

![MRF Form Navigation](/img/publication-process/navigating_mrf.png)
...
- **Manuscript Management Review** – Opens the [Manuscript Management Review](manuscript-management-review) page and displays the current review status.
...
- **Publication** – Opens the associated [Publication](publications) record if one exists. A publication record is created after the manuscript is marked as accepted for publication.

## Complete the Manuscript Record Form
...
![New MRF](/img/publication-process/new_mrf.png)
...
![Adding Authors](/img/publication-process/adding_authors.png)

---

## Remove an Author or Affiliation
...
## Change the DFO Corresponding Author
...
### If an Author Does Not Appear in the Author List

If the author you are searching for does not appear in the list, create a new author record.

See [Create a New Author](../support-and-resources/more-features#create-a-new-author).

### If a Group Author Does Not Appear in the Organization List

If the organization or group author does not appear in the list, create a new organization record.

See [Create a New Organization](../support-and-resources/more-features#create-a-new-organization).
...
## Update the Manuscript Working Title

The working title is automatically populated from the title entered when the manuscript was created.

![General Information](/img/publication-process/general_information.png)
...
![Plain Language Summary](/img/publication-process/pls.png)
...
### Select the Source Language of the PLS
...
## Confirm Author Approval of the Plain Language Summary
...
![Relevance](/img/publication-process/relevance.png)
...
## Indicate Potential Public Interest
...
![Funding](/img/publication-process/funding.png)
...
## Submit the Manuscript for Management Review
...
![Add Manager](/img/publication-process/add_manager.png)

![In Review](/img/publication-process/in_review.png)
...
:::
## Submit the Manuscript to the Single Window
...
![Submit to Single Window](/img/publication-process/submit_single_window.png)
...
## Submit to a Third-Party Journal
...
### Record the Initial Submission to a Journal
...
![Accept for Publication](/img/publication-process/accept_for_publication.png)
...
![Reminder](/img/publication-process/reminder.png)
...
![Regional Manuscripts](/img/publication-process/regional_manuscripts.png)
...
## Share a Manuscript Record Form
...
![Sharing](/img/publication-process/sharing.png)
...
![New Share](/img/publication-process/new_share.png)
