...
## My Manuscripts Page {/* #open-the-my-manuscripts-page */}
...
- **Manuscript Management Review** – Opens the [Manuscript Management Review](manuscript-management-review.mdx) page and displays the current review status.
...
- **Publication** – Opens the associated [Publication](./publications.mdx) record if one exists. A publication record is created after the manuscript is marked as accepted for publication.
...
See [Create a New Author](../support-and-resources/more-features.mdx#create-a-new-author).
...
See [Create a New Organization](../support-and-resources/more-features.mdx#create-a-new-organization).
...
A publication can only be flagged for the [Planning Binder](./manuscript-management-review.mdx#planning-binder) if it has potential public interest!
...
- Follow the steps in **[Invite a User](../support-and-resources/more-features#invite-a-user)**.
