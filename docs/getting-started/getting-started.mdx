...
You are now ready to use the application! Check out the [Portal Navigation](../portal-features/portal-navigation) for more information on how to navigate the application!
