...
## My Manuscript Management Reviews Page

You can check the status of manuscripts you have reviewed or have been selected to review on the **My Manuscript Management Reviews** page.

To access the **My Manuscript Management Reviews** page:

1. Expand the page selection menu by hovering your mouse over the left-sidebar menu.
2. Select **My Manuscript Management Reviews**.
...
On the **My Manuscript Management Reviews** page, you will see a list of all manuscripts awaiting your review. Click on a pending Manuscript Record Form (MRF) to begin reviewing it.

![My Manuscript Management Reviews](/images/publication-process/my_management_reviews.png)

## Reviewing an MRF

![Manuscript Management Reviews](/images/publication-process/management_review.png)
...
@tab Third-Party Journal Publications
...
4. Click the **Manuscript Management Review** button in the side menu to return to the Manuscript Management Review page.
...
2. Click the **Manuscript Management Review** button in the side menu to return to the Manuscript Management Review page.

#### Management Comments

![Management Comments](/images/publication-process/management_comments.png)

If you intend to forward or reassign the manuscript management review to another manager, or if you have feedback you would like the author to address, you must record your comments in the **Manager Comments** textbox. These comments will be visible to anyone with current or future access to this manuscript record.

If you intend to approve and complete the manuscript management review, comments are not required.
...
- A manager comment is required for all actions other than to `complete` the manuscript management review.

:::

![Manuscript Management Reviews](/images/publication-process/decision.png)
...
- **Complete**
  ...
  :::
  - You've reviewed this manuscript for publication and are ending the manuscript management review process.

- **Revision required**
  - You flag manuscript management review comments that the author should address before providing your approval.
...
- **Refer to next manager**
  ...
  include clear notes and recommendations for the next manager. This is especially important if you think that a revision is required.
  :::
...
To submit a Manuscript Management Review:

1. Click the **SUBMIT** button.
2. Select the decision you wish to make and click the **NEXT** button.
3. If you are forwarding the manuscript management review to another manager:
   - Click the **Next Manuscript Management Reviewer** search box and type the name of the division manager.
