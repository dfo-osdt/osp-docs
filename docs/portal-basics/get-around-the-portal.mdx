...
![Dashboard](./images/get-around-the-portal/dashboard.png)
...
The **User Menu button** opens the menu where you can access your **[Account Settings](../settings/account-settings.mdx)**, return to the dashboard, and **Logout**. To open the **User Menu**, select the **User Menu button** from the top-right navigation bar.
...
The **CREATE MANUSCRIPT RECORD button** under the *Need a Management Review?* section allows you to launch the [Manuscript Record Creator Tool](../manuscript-record-forms/manuscript-record-form.mdx#create-a-new-manuscript-record-form) directly from the Dashboard.

#### Add Publication {/* #add-publication */}

The **ADD PUBLICATION button** under the *Already Reviewd?* section allows you to launch the [Add Publication Tool](../publications/publications.mdx#creating-a-record-for-an-existing-publication) directly from the Dashboard.
