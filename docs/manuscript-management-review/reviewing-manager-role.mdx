...
Reviews the manuscript for compliance with the <ExternalLocalizedLink linkKey="crownCopyright">**Intellectual Property Policy/Copyright Act**</ExternalLocalizedLink>, the <ExternalLocalizedLink linkKey="privacyAct">**Privacy Act**</ExternalLocalizedLink>, the Financial Administration Act (with respect to approvals of publication costs) and the <ExternalLocalizedLink linkKey="codeOfConduct">**Values and Ethics Code for DFO**</ExternalLocalizedLink>.
...
For more information please refer to the <ExternalLocalizedLink linkKey="sciencePubPolicy">**Fisheries and Oceans Canada National Policy for Science Publications**</ExternalLocalizedLink>.
