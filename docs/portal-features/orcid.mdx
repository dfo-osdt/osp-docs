...
Follow these steps if you **do not already have** an ORCID account:

1. Navigate to [osp-pso.ent.dfo-mpo.ca](https://osp-pso.ent.dfo-mpo.ca/) and log in.
2. Click the **User Menu** button in the top-right corner of the page.
3. Select the **Settings** button.
4. In the **Settings** menu on the left, click the **Author Profile** button.
5. Under the **ORCID Integration** section, click **CREATE OR CONNECT YOUR ORCID ID**.
6. On the ORCID page, click the **Register now** link under the **Sign in to ORCID** header.
...
15. Congratulations! Your ORCID account is now created, verified, and linked to your OSP profile!

## Add an Existing ORCID to Your OSP Profile

Follow these steps if you **already have** an ORCID account and want to link it to your OSP profile:

1. Navigate to [osp-pso.ent.dfo-mpo.ca](https://osp-pso.ent.dfo-mpo.ca/) and log in.
2. Click the **User Menu** button in the top-right corner of the page.
3. Select the **Settings** button.
4. In the **Settings** menu on the left, click **Author Profile**.
5. Under the **ORCID Integration** section, click **CREATE OR CONNECT YOUR ORCID ID**.
...
8. Click **CONTINUE**.
9. Congratulations! Your ORCID account is now linked to your OSP profile!

## Authorize Access

![Authorize](/img/portal-features/orcid_authorize.png)
...
![Authentication](/img/portal-features/orcid_authentication.png)
...
1. Navigate to the **ORCID Integration** section under **Author Profile** in the OSP.
2. Click the **ADD EMPLOYMENT** button.
3. Complete the *Add a DFO employment to ORCID* form, including:
...
![Employment](/img/portal-features/orcid_employment.png)
...
4. Click the **Visibility** button in the top-right corner of the record to expand the *Visibility Settings*.
...
1. Navigate to the **ORCID Integration** section under **Author Profile** in the OSP.
2. Click the employment record you wish to edit.
...
1. Navigate to the **ORCID Integration** section under **Author Profile** in the OSP.
2. Click the employment record you wish to delete.
3. Click the **DELETE** button **>** Confirm by clicking **DELETE** again.

:::warning
Deleting the employment record will remove it from both the OSP and your ORCID profile!
:::
...
![Authenticated ORCID Example](/img/portal-features/orcid_authorized_example.png)

### Use the Official DFO Source Badge
...
![Employment Entry Example](/img/portal-features/orcid_role_title.png)

### Update Employment Records When Your Employment Changes
...
![Employment History](/img/portal-features/orcid_updated_employment.png)