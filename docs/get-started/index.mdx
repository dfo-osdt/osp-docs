...
### Site Address (URL) {/* #site-address-url */}
...
![Login Page](./images/index/login.png)
...
You are now ready to use the application! Check out the [Navigating the Portal](../portal-basics/) for more information on how to navigate the application!
