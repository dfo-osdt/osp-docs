...
![Invite](/img/support-and-resources/invite.png)
...
To view the status of sent invitations, see **[Sent Invitations](../portal-features/account-settings#sent-invitations)**.
