...
- **ORCID**: Green circle with the letters "iD" left of an author's name denote if the author has associated an [ORCID](../references/orcid.mdx) with their account.
...
- **Duplicate**: A grey square with an arrow pointing inside it denotes the [duplicate action](./manuscript-record-form-features.mdx#duplicate-a-manuscript-record-form). This action allows you to create a copy of this MRF.

![My Manuscripts Page](./images/my-manuscript-records-page/my-manuscript-records.png)
