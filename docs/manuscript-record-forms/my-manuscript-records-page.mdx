...
- **Duplicate**: A grey square with an arrow pointing inside it denotes the [duplicate action](./manuscript-record-form-features#duplicate-a-manuscript-record-form). This action allows you to create a copy of this MRF.
