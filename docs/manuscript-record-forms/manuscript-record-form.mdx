---
sidebar_position: 2
description: How to create and manage your MRF.
---
...
The **My Manuscripts** page lists all manuscript records you have created or that have been shared with you. The default view displays MRF's which have been submitted and are under going Manuscript Management Review. You can change the current MRF view, or create a new MRF from the **Manuscript Records** menu on the left-side of the page. 

![Dashboard](./images/my_manuscripts_page.png)

## Create a New Manuscript Record Form {/* #create-a-new-manuscript-record-form */}
...
- Click **Back** to modify information entered in previous steps.
- Click **Cancel** to exit the manuscript creation process without saving.

## Navigate the Manuscript Record Form {/* #navigate-the-manuscript-record-form */}

The Manuscript Record Form is organized into sections that allow you to enter manuscript details.

![MRF Form Navigation](./images/navigating_mrf.png)

### Additional Information {/* #additional-information-1 */}

- **Section Menu** – Use the left sidebar to open sections such as **General Information**, **Authors**, **Peer Reviewers**, and **Funding Sources**.
- **Progress Indicators** – Sections with incomplete required fields are highlighted.
- **Required Fields** – Fields marked with an asterisk (*) must be completed before submitting the form.
- **Save Options** – Save your progress using the **Floppy-Disk** button or the **Save** button.
- **Form Status** – The top-right corner displays the manuscript status (for example, **Draft** or **In Review**).

## Understand the Section Menu {/* #understand-the-section-menu */}

The **Section Menu** provides access to pages related to the Manuscript Record Form (MRF) and its review process.
...
- **Manuscript Management Review** – Opens the [Manuscript Management Review](../manuscript-management-review/manuscript-management-review.mdx) page and displays the current review status.
- **Manuscript Progress** – Opens the [Manuscript Progress](#view-manuscript-progress) page and shows the workflow and current progress of the MRF.
- **Sharing** – Opens the [Sharing](#share-a-manuscript-record-form) page where you can share the MRF with additional users. Authors and management review users automatically have access and do not need to be added.
- **Publication** – Opens the associated [Publication](../publications/publications.mdx) record if one exists. A publication record is created after the manuscript is marked as accepted for publication.

## Complete the Manuscript Record Form {/* #complete-the-manuscript-record-form */}

After creating an MRF, the system assigns a unique ID and sets the status to **Draft**. You must complete all required fields before submitting the manuscript for management review.

![New MRF](./images/new_mrf.png)
...
## Upload a Manuscript {/* #upload-a-manuscript */}
...
## Add Authors and Affiliations {/* #add-authors-and-affiliations */}
...
**DFO** is selected as the default affiliation to speed up data entry. Change the affiliation when adding authors from other organizations.
:::
...
![Adding Authors](./images/adding_authors.png)
...
See [Create a New Author](../supporting-tasks/more-features.mdx#create-a-new-author).
...
See [Create a New Organization](../supporting-tasks/more-features.mdx#create-a-new-organization).
...
## Add Peer Reviewers {/* #add-peer-reviewers */}

Add the scientists who conducted the peer review of the manuscript.

:::tip
This section is **required for DFO publications** and **optional for data reports and contractor reports**.
:::
...
1. Click **+**.
2. Search for the reviewer by name or email.
3. Select the reviewer from the search results.
4. Click **Save**.
...
- At least **two subject matter experts** must complete a peer review of the report.
- The **Peer Review** section will not appear on the Third-Party Publication MRF as it is not required.
---

## Update the Manuscript Working Title {/* #update-the-manuscript-working-title */}

The working title is automatically populated from the title entered when the manuscript was created.

![General Information](./images/general_information.png)
...
You can save changes by:

- Clicking the **Floppy-Disk** icon in the bottom-right corner of the page.
- Scrolling to the bottom of the page and clicking **Save**.

## Update the Lead Region {/* #update-the-lead-region */}
...
## Add the Abstract {/* #add-the-abstract */}
...
## Add a Plain Language Summary {/* #add-a-plain-language-summary */}

Provide a plain language summary (PLS) to improve accessibility of the publication.

![Plain Language Summary](./images/pls.png)
...
- Guidance on writing plain language content is available from the Government of Canada:  
  [Communications Community Office](https://www.canada.ca/en/privy-council/services/communications-community-office/communications-101-boot-camp-canadian-public-servants/plain-language-accessibility-inclusive-communications.html)

### Select the Source Language of the PLS {/* #select-the-source-language-of-the-pls */}

Choose the language used for the required plain language summary.
...
### Generate a Plain Language Summary Draft {/* #generate-a-plain-language-summary-draft */}
...
When using AI tools within the Government of Canada network, review the Treasury Board of Canada Secretariat guidance on responsible AI use:  
...
Save your changes after adding or editing the summary by:
...
## Confirm Author Approval of the Plain Language Summary {/* #confirm-author-approval-of-the-plain-language-summary */}
...
## Select a Functional Area {/* #select-a-functional-area */}
...
## Add the Relevance Summary {/* #add-the-relevance-summary */}
...
## Indicate Potential Public Interest {/* #indicate-potential-public-interest */}

Identify whether the manuscript may have public interest.

:::info

A publication can only be flagged for the [Planning Binder](../manuscript-management-review/manuscript-management-review.mdx#planning-binder) if it has potential public interest!
...
![Public-Interest](./images/public_interest.png)
---

## Set Report Licensing {/* #set-report-licensing */}

Specify whether the report should be licensed under the **[Open Government Licence – Canada](https://open.canada.ca/en/open-government-licence-canada)**.

:::tip
This section is visible only for **EOS Secondary Scientific and Technical Publications**.
:::
...
## Indicate Open Publication {/* #indicate-open-publication */}
...
## Add Funding Sources {/* #add-funding-sources */}
...
After adding funding sources, save your changes by:
...
### Edit a Funding Source {/* #edit-a-funding-source */}

Update the information for an existing funding source.

**Steps**

1. Click the **Pencil** icon next to the funding source.
2. Update the required fields.
3. Click **Save**.

**Result**

The updated funding source information is saved.

---

### Delete a Funding Source {/* #delete-a-funding-source */}

Remove a funding source from the Manuscript Record Form.

**Steps**

1. Click the **Garbage Can** icon next to the funding source.
2. Click **OK** to confirm.

**Result**

The funding source is removed from the Manuscript Record Form.

## Submit the Manuscript for Management Review {/* #submit-the-manuscript-for-management-review */}

Submit the Manuscript Record Form (MRF) once all required fields are complete.

:::important
The MRF **applicant or any listed author** can submit the manuscript for management review.
...
5. Click **Next**.
6. Enter the name of the **Division Manager** in the search field.
7. Select the manager from the search results.
8. Click **Submit**.

**Conditional Steps**

If the **Division Manager** does not appear in the search results:
...
![In Review](./images/in_review.png)

---


## Submit the Manuscript for Publication {/* #submit-the-manuscript-for-publication */}

After completing the **Manuscript Management Review Process**, you can submit the manuscript to **Science Publications**.

### EOS Secondary Scientific and Technical Publication {/* #eos-secondary-scientific-and-technical-publication */}

:::warning
**Required Information**

You must obtain a **Catalogue Number** before submitting the manuscript to Science Publications.

To request a Catalogue Number:
...
:::
## Submit the Manuscript to Science Publications {/* #submit-the-manuscript-to-science-publications */}

Submit the manuscript to the **Science Publications** after completing the Manuscript Management Review Process.

![Submit to Science Publications](./images/submit_science_publications.png)
...
- **Catalogue Number** – Enter the assigned catalogue number.
...
The manuscript is submitted to **Science Publications** for review and publication. You will receive a notification when the manuscript is published or if changes are required.

:::info
You may still upload your manuscript as a PDF, however, Science Publications will not be able to make edits if required. If edits are required Science Publications will contact you via email.
:::
---

## Submit to a Third-Party Journal {/* #submit-to-a-third-party-journal */}
...
### Record the Initial Submission to a Journal {/* #record-the-initial-submission-to-a-journal */}

**Steps**

1. Open the Manuscript Record Form.
2. Select **Manuscript Progress** from the section menu.
3. Click **Mark as Submitted** under **Initial Submission for Publication**.
4. Enter the submission date in the **Submitted to Journal On** field.
...
The Manuscript Record Form records the date the manuscript was submitted to the journal.
## Record Manuscript Acceptance {/* #record-manuscript-acceptance */}

Record when the manuscript has been accepted for publication.

![Accept for Publication](./images/accept_for_publication.png)
...
- **Submitted to Journal On** – Update the submission date if required.
- **Accepted for Publication On** – Enter the acceptance date.
- **Journal/Series** – Select the journal or publication series.

5. Click **Update**.

**Conditional Steps**

If the journal is not listed:

- Email the **OSP Support Team** to request that the journal be added:  
  DFO.OpenScience-ScienceOuverte.MPO@dfo-mpo.gc.ca

**Result**

The Manuscript Record Form is updated to show that the manuscript has been accepted for publication.

---

## Withdraw a Manuscript {/* #withdraw-a-manuscript */}

Withdraw the manuscript if it should no longer proceed through the publication process.
...
The manuscript is marked as withdrawn in the Manuscript Record Form.
...
These reminders help ensure the publication lifecycle is tracked accurately and that manuscript information remains up to date in the OSP.
## Access Regional Manuscripts {/* #access-regional-manuscripts */}

Users with the **Regional Editor** role can view and edit Manuscript Record Forms (MRFs) where their region is the **Lead Region**.

- When the MRF status is **Draft** or **In Review**, Regional Editors can edit and save changes.
- When the MRF status is **Reviewed**, Regional Editors can only view the MRF.

![Regional Manuscripts](./images/regional_manuscripts.png)

**Steps**

1. Hover over the left side of the screen to expand the navigation menu.
2. Click **Regional Manuscripts**.
3. Locate the manuscript.

**Optional Steps**

To filter results:

- Enter a manuscript title or author name in the **Filter** field.
- Select a manuscript state from the **Regional Manuscripts** panel.

4. Click the manuscript title to open the record.

**Result**

The selected Manuscript Record Form opens.
...
- Follow the steps in **[Invite a User](../supporting-tasks/more-features#invite-a-user)**.

**Result**

The selected user receives access to the Manuscript Record Form with the assigned permissions.

![New Share](./images/new_share.png)
