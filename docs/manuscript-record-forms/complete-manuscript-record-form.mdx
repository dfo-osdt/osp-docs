...
- See [Creating an Author](../common-features/author-and-affilliate-management) if an author does not appear within the searchable list.
- See [Creating an Organization](../common-features/author-and-affiliate-management) if an organization does not appear within the searchable list.
