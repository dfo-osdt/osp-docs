...
- See [**Creating an Author**](../common-features/author-and-affiliate-management.mdx#create-a-new-author) if an author does not appear within the searchable list.
- See [**Creating an Organization**](../common-features/author-and-affiliate-management.mdx#create-a-new-organization) if an organization does not appear within the searchable list.
...
A publication can only be flagged for the [**Planning Binder**](../manuscript-management-review/submit-review.mdx#planning-binder) if it has potential public interest!
