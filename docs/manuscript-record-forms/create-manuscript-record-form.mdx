...
- **Publication** – Opens the associated [Publication Record](../publications/my-publications-page) if one exists. A publication record is automatically created after the manuscript is marked as accepted for publication.
