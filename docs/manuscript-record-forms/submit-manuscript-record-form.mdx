...
## Unsubmit from Manuscript Management Reviews {/* #unsubmit-from-manuscript-management-reviews */}
...
1. Click **Unsubmit**.
2. Write reason for unsubmission.
...
![Unsubmit MRF](./images/submit-manuscript-record-form/unsubmit-mrf.png)

![Unsubmit Email](./images/submit-manuscript-record-form/unsubmit-email.png)
