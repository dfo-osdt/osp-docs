---
sidebar_position: 1
description: What publications can be created and where to create them.
---
# Overview
...
## Types of Publications {/* #types-of-publications */}

### DFO Publications {/* #dfo-publications */}
...
[→ Get started with the DFO Manuscript Record Form](./manuscript-record-form.mdx)

### Third-Party Journal Publications {/* #third-party-journal-publications */}
...
[→ Get started with the Third-Party Manuscript Record Form](./manuscript-record-form.mdx)
...
## Common Process Steps {/* #common-process-steps */}
