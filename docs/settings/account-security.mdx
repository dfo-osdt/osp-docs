---
sidebar_position: 4
description: Monitoring your account security
---
# Account Security
...
![Authentication History Table](./images/account-security/authentication-history-table.png)
...
not. If successful, a green check mark will be displayed. If unsuccessful, a red
