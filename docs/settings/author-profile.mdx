...
Information within your Author Profile is synchronized from your [**User Profile**](./user-profile.mdx).
...
If you have an ORCID but **do not** want to authenticate your OSP account with ORCID, you can manually add it to your Author Profile. However, it is highly recommended that you connect and authenticate your OSP account with your ORCID. Please see the [**ORCID section**](../references/orcid.mdx) for more information.
...
For detailed instructions on ORCID integration and how to connect your ORCID account with the OSP, please refer to the [**ORCID section**](../references/orcid.mdx).
