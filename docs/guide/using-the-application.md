...
### 4.2.2 - Manuscript Record Creation
1. From the "Manuscripts" menu on the left, left-click on the "+ Create Manuscript" button.
2. Select the type of manuscript you wish to publish by left-clicking on the text and left-click on the "Continue" button.
3. Left-click on the "Title" text box and type in the name of your manuscript. Left-click on the "DFO Regions" selection box and left-click on the region to select it. Left-click on the "Continue" button.
4. Left-click on the "Create" button to create the manuscript, "Back" if you need to correct information, or "Cancel" to cancel the creation of the manuscript.

### 4.2.3 - Manuscript Record Form
...
3. Begin typing the name of the Author or Affiliate you would like to add. If the name exists in the database, it will appear, and you can left-click on it to select it. If the name does not appear, continue to step 4; otherwise, continue to step 6.
...
### 4.2.4 - Manuscript Management Review

You can check the management review status of your manuscript by left-clicking on the "Management Review" page button located in the "Manuscript Record" menu in the top-left of the "Manuscript Record" page.

### 4.2.5 - Manuscript Progress

Upon completion of the Management Review, the Author can update the journal submission status of the manuscript. To do this navigate to the "Manuscript Progress" page by left-clicking on the "Manuscript Progress" button located in the "Manuscript Record" menu in the top-left of the "Manuscript Record" page.

#### Mark as Submitted

To mark the manuscript as submitted to a journal:

1. Left-click on the "MARK AS SUBMITTED" button.
2. Left-click on the "Submitted to Journal On" text box and type in the date in the YYYY-MM-DD (Year, Month, Day) format or left-click on the Calendar icon located at the right-end of the text box and select the applicable year, month, and day.
3. Left-click on the "UPDATE" box to confirm the date.
...
1. Left-click on the "ACCEPTED FOR PUBLICATION" button.
2. Confirm the date that the manuscript was submitted to the journal on.
3. Left-click on the "Accepted for Publication On" text box and type in the date in the YYYY-MM-DD (Year, Month, Day) format or left-click on the Calendar icon located at the right-end of the text box and select the applicable year, month, and day.
4. Left-click on the "Journal" text box and begin typing the name of the journal. If the journal is in the database, their name will appear. Left-click on their name to select them. If their name does not appear, please send an email to [OSP Support](mailto:DFO.OpenScience-ScienceOuverte.MPO@dfo-mpo.gc.ca) to have them added.
5. Left-click on the "UPDATE" button to confirm the publication acceptance entry.

##### Withdraw Manuscript

1. Left-click on the "WITHDRAW MANUSCRIPT" button.
2. Left-click on the "WITHDRAW" button to confirm that the author is no longer considering the manuscript for publication.

### 4.2.6 - Manuscript Record Sharing

You can share your manuscript or see a history of who you have shared your manuscript with in the "Sharing" page. To do this, navigate to the "Sharing" page by left-clicking on the "Sharing" button located in the "Manuscript Record" menu in the top-left of the "Manuscript Record" page.

#### Share a Manuscript

To share a manuscript with another user:

1. Left-click on the "SHARE" button.
2. Left-click on the "User" text box to select it. Begin typing the name or email address of the user. If the user is in the database, their name will appear. Left-click on their name to select them. If their name does not appear, continue onto Step-3 to invite them to the Open Science Portal. If not, continue onto Step-5.
3. Left-click on the "Not the user you are looking for?" dialog button.
4. Populate the user's First Name, Last Name, E-Mail, and Preferred Language.
5. Left-click on the "INVITE" button to invite the user to the Open Science Portal.
6. Left-click on the "Can Edit" toggle button if you would like to enable the user to edit this manuscript application. (Disabled by default)
7. Left-click on the "Can Delete" toggle button if you would like to enable the user to delete this manuscript application. (Disabled by default)
8. If you would like the user's ability to access this manuscript to be only temporary, left-click on the "Expires On" dialog box and type in the date you wish to end the sharing of this manuscript. You may also left-click on the Calendar icon to select a date.
9. Left-click the "SHARE" button to share this manuscript.

#### Edit a Manuscript Share

If you have shared a manuscript record and you wish to modify the permissions of that share:

1. Left-click on the Pencil Icon located under the "Actions" column on the right-side of the Share Record.
2. Update the sharing attribute(s) you wish to change.
3. Left-click on the "SAVE" button to apply the changes.

#### Delete a Manuscript Share

If you have shared a manuscript record and you wish to delete/remove the share:

1. Left-click on the Trash Can Icon located under the "Actions" column on the right-side of the Share Record.
2. Confirm the deletion of this share access by left-clicking on the "OK" button.

### 4.2.7 - My Publications Page
...
1. Expand the page selection menu by hovering the mouse over the left-sidebar menu.
2. Left-click on "My Publications"

### 4.2.8 - Publication Update Record
...
1. Left-click on the "In Progress" button in the "Publications" menu located on the left-side of the page.
2. Left-click on the publication you wish to update.
...
To update the "Corresponding Author" status of an added Author or Affiliate, left-click on their name and left-click on the "Corresponding Author" slider to toggle the state.

##### Removing an Author or Affiliate

To remove an Author or Affiliate, left-click on the "x" icon located on the right side of the Author's name.
...
1. Left-click on the "Title" text box to select it.
2. Apply your edits to the title.
3. Scroll down to the bottom of the page and left-click on the "SAVE" button.

##### Journal

To update the Journal you are submitting to:

1. Left-click on the "Journal" text box to select it.
2. Press the "Backspace" key on the keyboard or left-click on the circular X icon located on the right-side of the "Journal" text box to remove the current Journal.
3. Begin typing the name of the journal. If the journal is in the database, their name will appear. Left-click on their name to select them. If their name does not appear, please send an email to [OSP Support](mailto:DFO.OpenScience-ScienceOuverte.MPO@dfo-mpo.gc.ca) to have them added.

##### Digital Object Identifier (DOI)

To update the DOI of your publication:

1. Left-click on the "DOI" text box to select it.
2. Type in the DOI.
...
1. Left-click on the "Accepted on" text box to select it.
2. Press the "Backspace" key on the keyboard to remove the current date and type in the new date or left-click on the calendar icon located on the right-side of the "Accepted on" text box and select the updated date.

##### Publication Access

To declare that your publication is published as open access, left-click on the "Published as Open Access" toggle button to set it to "True".

To update the embargo date on your publication:

1. Left-click on the "Embargoed Until" text box to select it.
2. Type in the new date or left-click on the calendar icon located on the right-side of the "Accepted on" text box and select the updated date.

#### Attach Publication

To attach a PDF copy of your publication:

1. Left-click on the "Upload the publication" dialog box.
2. Navigate to the location of the PDF on your computer.
3. Left-click the PDF to select it.
4. Left-click the "Open" button to add it to the upload queue.
5. Left-click on the "UPLOAD" button located on the right-side of the "Upload the publication" dialog box.

#### Save

To save your changes at any time, scroll to the bottom of the page and left-click on the "SAVE" button.

#### Mark as Published

To mark your publication as published, scroll to the bottom of the page and left-click on the "MARK AS PUBLISHED" button. This will automatically mark the publication as published on today's date. If you need to adjust the "Published On" date:

1. Navigate up the page to the "Publication Dates" section.
2. Left-click on the "Published on" text box to select it.
3. Press the "Backspace" key on the keyboard to remove the current date and type in the new date or left-click on the calendar icon located on the right-side of the "Published on" text box and select the updated date.
...
1. Left-click on the "CREATE PUBLICATION" button located at the bottom of the "Publications" menu on the left-side of the page.
2. Review the disclaimer in the dialog box and left-click on the "NEXT" button.
3. Populate each "Publication Details" box by left-clicking on them to select them. Once populated, left-click on the "NEXT" button to confirm.
    - Title
    - Journal
    - DOI
4. Populate each "Publication Dates" box by left-clicking to select them:
    - Accepted On (Optional)
    - Published On
5. If the publication is published as open access, left-click on the "Published as Open Access" toggle button to set it to *TRUE*.
6. If the publication is under an embargo, left-click on the "Embargoed Until" text box to select it. If not, continue onto Step-8.
7. Type in the new date or left-click on the calendar icon located on the right-side of the "Accepted on" text box and select the updated date.
8. Left-click on the "CREATE" button to create the publication entry.
...
1. Left-click on the "Published" button from the "Publications" menu located on the left-side of the page.
2. Left-click on the new publication entry from the list of "Published" publications to select it.
3. Under the *Adding Author(s) and Affiliation(s)* section, left-click on the circular "+" button.
4. Left-click on the "Author" dialog box to select it.
5. Begin typing the name of the Author or Affiliate you would like to add. If the name exists in the database, it will appear, and you can left-click on it to select it. If the name **does not** appear, continue onto step 4, else continue to step 6.
6. Left-click on the circular "+" button to add a new Author or Affiliate record.
7. Add their First Name, Last Name, Organization Affiliation, E-Mail, ORCID (Optional). Left-click the "Create" button to add the new Author Record.
8. Left-click on whether this Author is the "Corresponding Author" or not.
9. Left-click on the "Add" button to add this Author or Affiliate.
10. Repeat steps 3 - to - 9 until all Authors or Affiliates have been added.
11. Scroll to the bottom of the page and left-click on the "Upload the publication" dialog box.
12. Navigate to the location of the PDF on your computer.
13. Left-click the PDF to select it.
14. Left-click the "Open" button to add it to the upload queue.
15. Left-click on the "UPLOAD" button located on the right-side of the "Upload the publication" dialog box.
...
### 4.3.1 - Manuscript Creation
The Process of Creating and Submitting a Manuscript is the process as a Author. Please see [4.2.1 - Manuscript Creation](#_4-2-1-manuscript-creation) on how to create and submit a Manuscript.

### 4.3.2 - Manuscript Review
...
#### Pending Reviews
You can see a list of manuscripts which require action from you on the *Pending* Page. You can navigate to the *Pending* page from the [My Reviews page](#manuscript-review-page) by left-clicking on the *Pending* button located in the *Reviews* menu on the left-side of the screen. A list of all manuscripts await action from you will now be listed. To take action left-click on the manuscript you would like to review.

##### Review the Manuscript Form
To review information submitted by the Author or download a copy of the submitted manuscript, left-click on the *Form* button located on the left-side of the screen under the *Manuscript Record* menu.
...
3. Withhold and Complete the review process (Regional Director of Science or Director General **ONLY**)
    - You withhold this manuscript for publication and are ending the management review process. Only an RDS or DG can make this decision.
4. Withhold and Forward
    - You recommend this manuscript be withheld for publication and are forwarding it to a higher level manager.
5. Reassign
    - You are not the correct manager to review this manuscript and reassign this review to the proper manager without making a recommendation.

###### Submitting a Review Decision
To submit a Management Review Decision:
1. Left-click in the *Manager Comment* text box to select it. Input any comments you have which support your decision or provide usable feedback to the author or assisting manager. (This step is optional if you are *Approving and Completing* this manuscript.)
2. Left-click on the *SAVE COMMENTS* button to save your comments. If you are not ready to make a review decision you can safely navigate away from this page without losing your comments.
3. Left-click on *SUBMIT DECISION*. This will open up the Decision dialog box.
4. Select the Decision you wish to make.
5. Left-click on the "Next Management Reviewer" text box to select it and begin typing the first and last name of the Manager you would like to assign. If the name exists in the database, it will appear, and you can left-click on it to select it. If the name **does not** appear, continue onto step 6, else continue onto step 8.
6. To add a Manager, left-click on the circular "+" button to add a new Manager.
7. Input their First Name, Last Name, E-Mail, and their Prefered Language. Left-click on the "INVITE" button to invite them to the Open Science Portal application.
8. Left-click on the "NEXT" button to confirm Selected Next Manager.
9. Review the Decision Disclaimer. If you agree with it, left-click on the "Yes" check-box to select it. Then left-click on the "SUBMIT" button confirm your decision.
