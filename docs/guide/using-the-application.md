...
3. Click on the ***Title Text Box*** and type in the name of your manuscript.
4. Click on the ***DFO Regions Selection Box*** and select the ***Lead Region***. Click the ***Continue Button***.
...
select it. If the name does not appear, continue to step 4; otherwise, continue
to step 6.
...
6. Click on whether this Author is the ***Corresponding Author***.
...
or Affiliate, Click on their name and Click on the ***Corresponding Author
...
1. Click on the ***Title Dialog Box*** to select it.
2. Backspace the text you wish to change.
3. Type your changes.
4. Click on the circular ***Floppy-Disk Icon Button*** on the bottom-right side
...
1. Click on the ***Lead Region Dialog Box***.
2. Click on the region you would like to switch to.
3. Click on the circular ***Floppy-Disk Icon Button*** on the bottom-right side
of the page, or scroll down to the bottom of the page and Click on the ***Save
Button*** to save your changes.
...
After adding the Relevance Summary, Click on the circular ***Floppy-Disk Icon
...
If you selected ***Yes*** and/or added any explanatory text, Click on the
circular ***Floppy-Disk Icon Button*** on the bottom-right side of the page, or
...
1. Click on the ***+ ADD FUNDING SOURCE Button*** on the right side of the
dialog box.
2. Click on the ***Funder Dialog Box*** and select the applicable source.
3. Click on the ***Title Dialog Box*** to select it and type in the title or
name of the funding source.
4. Click on the ***Description Dialog Box*** to select it and type in a brief
explanation of the funding source requirements and how your work achieves
them. If your funding source was not present under the "Funder" drop-down menu,
...
Once all Funding Sources have been added, Click on the circular ***Floppy-Disk
Icon Button*** on the bottom-right side of the page, or scroll down to the
bottom of the page and Click on the ***Save Button*** to save your changes.
...
1. Click on the ***Pencil Icon Button*** located on the right side of the
funding source.
...
1. Click on the ***Garbage Can Icon Button*** located on the right side of the
funding source.
2. Click on the ***OK Button*** on the dialog box to confirm that you wish to
remove this funding source.

#### Manuscript Upload (Required)

Manuscript upload allows you to upload the most recent version of your
manuscript in a PDF file format. As this submission form is dynamic, you can
re-upload your manuscript if changes have been made during your submission.

1. Click on the ***Upload Manuscript Dialog Box***.
...
To download any previously submitted manuscript, Click on the ***Download Icon
Button located to the right of the uploaded manuscript.
...
5. Click on the ***Division Manager Dialog Box*** to select it. Begin typing the
name of the division manager you would like to review your manuscript. If the
manager is in the database, their name will appear. Click on their name to
select them. If their name does not appear, continue onto Step-6 to invite them
to the OSP. If not, continue onto Step-9.
6. Click on the ***Not the user you are looking for? Dialog Button***.
7. Populate the manager's First Name, Last Name, E-Mail, and Preferred
Language.
8. Click on the ***INVITE Button*** to invite the manager to the OSP.
9. Click on the ***SUBMIT Button*** to submit the manuscript for review.
...
2. Click on the ***Submitted to Journal On Text Box*** and type in the date in
the YYYY-MM-DD (Year, Month, Day) format, or Click on the ***Calendar Icon
Button*** located at the right-end of the text box and select the applicable
year, month, and day.
...
3. Click on the ***Accepted for Publication On Text Box*** and type in the date
in the YYYY-MM-DD (Year, Month, Day) format, or Click on the ***Calendar Icon
Button*** located at the right-end of the text box and select the applicable
year, month, and day.
4. Click on the ***Journal Text Box*** and begin typing the name of the
...
2. Click on the ***User Text Box*** to select it. Begin typing the name or email
...
continue onto Step-3 to invite them to the OSP. If not, continue onto Step-5.
3. Click on the ***Not the user you are looking for? Dialog Button***.
4. Populate the user's First Name, Last Name, E-Mail, and Preferred Language.
5. Click on the ***INVITE Button*** to invite the user to the OSP.
6. Click on the ***Can Edit Toggle Button*** if you would like to enable the
user to edit this manuscript application. **(Disabled by default)**
7. Click on the ***Can Delete Toggle Button*** if you would like to enable the
user to delete this manuscript application. **(Disabled by default)**
8. If you would like the user's ability to access this manuscript to be only
temporary, Click on the ***Expires On Dialog Box*** and type in the date you
...
1. Click on the circular "+" button.
2. Click on the "Author" dialog box to select it.
3. Begin typing the name of the Author or Affiliate you would like to add. If the name exists in the database, it will appear, and you can Click on it to select it. If the name **does not** appear, continue onto step 4, else continue to step 6.
4. Click on the circular "+" button to add a new Author or Affiliate record.
5. Add their First Name, Last Name, Organization Affiliation, E-Mail, ORCID (Optional). Click the "Create" button to add the new Author Record.
...
1. Click on the "CREATE PUBLICATION" button located at the bottom of the "Publications" menu on the left-side of the page.
2. Review the disclaimer in the dialog box and Click on the "NEXT" button.
3. Populate each "Publication Details" box by Clicking on them to select them. Once populated, Click on the "NEXT" button to confirm.
    - Title
    - Journal
    - DOI
4. Populate each "Publication Dates" box by Clicking to select them:
    ...
    - Published On
5. If the publication is published as open access, Click on the "Published as Open Access" toggle button to set it to *TRUE*.
6. If the publication is under an embargo, Click on the "Embargoed Until" text box to select it. If not, continue onto Step-8.
...
1. Click on the "Published" button from the "Publications" menu located on the left-side of the page.
2. Click on the new publication entry from the list of "Published" publications to select it.
3. Under the *Adding Author(s) and Affiliation(s)* section, Click on the circular "+" button.
4. Click on the "Author" dialog box to select it.
5. Begin typing the name of the Author or Affiliate you would like to add. If the name exists in the database, it will appear, and you can Click on it to select it. If the name **does not** appear, continue onto step 4, else continue to step 6.
6. Click on the circular "+" button to add a new Author or Affiliate record.
7. Add their First Name, Last Name, Organization Affiliation, E-Mail, ORCID (Optional). Click the "Create" button to add the new Author Record.
...
11. Scroll to the bottom of the page and Click on the "Upload the publication" dialog box.
