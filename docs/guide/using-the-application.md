...
3. Begin typing the name of the Author or Affiliate you would like to add. If the name exists in the database, it will appear, and you can Click on it to select it. If the name does not appear, continue to step 4; otherwise, continue to step 6.
...
1. Click on the dialog box to select it.
...
1. Click on the "+ ADD FUNDING SOURCE" button on the right side of the dialog box.
2. Click on the "Funder" dialog box and Click to select the applicable source.
3. Click on the "Title" dialog box to select it and type in the title or name of the funding source.
4. Click on the "Description" dialog box to select it and type in a brief explanation of the funding source requirements and how your work achieves them. If your funding source was not present under the "Funder" drop-down menu, please provide the information of the funding provider and resource.
5. Click on "Create" to add the funder.
...
1. Click on the "Pencil" icon located on the right side of the funding source.
...
5. Click on the "Division Manager" dialog box to select it. Begin typing the name of the division manager you would like to review your manuscript. If the manager is in the database, their name will appear. Click on their name to select them. If their name does not appear, continue onto Step-6 to invite them to the Open Science Portal. If not, continue onto Step-9.
...
8. Click on the "INVITE" button to invite the manager to the Open Science Portal.
...
2. Click on the "User" text box to select it. Begin typing the name or email address of the user. If the user is in the database, their name will appear. Click on their name to select them. If their name does not appear, continue onto Step-3 to invite them to the Open Science Portal. If not, continue onto Step-5.
...
5. Click on the "INVITE" button to invite the user to the Open Science Portal.
6. Click on the "Can Edit" toggle button if you would like to enable the user to edit this manuscript application. (Disabled by default)
7. Click on the "Can Delete" toggle button if you would like to enable the user to delete this manuscript application. (Disabled by default)
...
1. Click on the Pencil Icon located under the "Actions" column on the right-side of the Share Record.
