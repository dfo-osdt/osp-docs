...
New to the OSP? Check out [Quick Start](./portal-basics/) to set up your account and learn the basics.

Need to create and submit a manuscript for manuscript management review? Go to [Manuscript Record Forms](./manuscript-record-forms) to determine which type of publication workflow you need.
