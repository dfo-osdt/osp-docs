...
## My Publications Page {/* #my-publications-page */}
...
![My Publications](./images/my_publications.png)
...
2. Click **NEXT**.
3. Complete the Publication Details form > Click **NEXT**:
    - Title
    - Journal Series
    - DOI (Optional)
    - Lead Region
4. Complete the Dates and Access form > Click **CREATE**:
...
A publication record with an **Accepted** status has been created. You may now [populate your record data](./publications.mdx#updating-a-publication-record) 

![Publication Details Form](./images/publication-details-form.png)
![Dates and Access](./images/dates-and-access-accepted.png)
...
5. Complete the **Publication Details form** > Click the **NEXT button**.
    ...
    - DOI (Optional)
    - Lead Region
6. Complete the Publication Dates and Publication Access form > Click **CREATE**.
    - Accepted On (Optional)
    - Published On
    - Published as Open Access
    - Embargoed Until (If applicable)

![Create Publication](./images/pub_create.png)

This will create a new publication record and open the **Publication Details form**.

## Updating a Publication Record {/* #updating-a-publication-record */}
...
![Update Publication](./images/pub_update_authors.png)

### Author(s) and Affiliation(s) {/* #authors-and-affiliations */}

#### Adding Author(s) and Affiliation(s) {/* #adding-authors-and-affiliations */}
...
#### Updating Author or Affiliation {/* #updating-author-or-affiliation */}
...
#### Removing an Author or Affiliate {/* #removing-an-author-or-affiliate */}
...
![Publication General Info](./images/pub_general_info.png)
...
![Published Work](./images/published_work.png)
...
![Supplementary File Types](./images/supplement_types.png)
...
### Mark as Published or Save {/* #mark-as-published-or-save */}

If your work is confirmed to be published:

1. Click the **MARK AS PUBLISHED button**.

This will mark your publication as "Published" and make it viewable under the [Publication Explorer](../portal-basics/find-and-explore-content.mdx).
...
## Deleting a Publication Record {/* #deleting-a-publication-record */}
...
A **Publication Record** that is created through the [Common Workflow Steps](../manuscript-record-forms/#common-process-steps) within the OSP cannot be deleted!
...
![Publication Delete](./images/publication_delete.png)
